-- Remove the column default that might be interfering
ALTER TABLE public.weekly_balances 
ALTER COLUMN remaining_balance DROP DEFAULT;

-- Manually fix all existing records
